...
import { docTypeSaga } from './saga';
import { DocTypeState } from './types';
...
export const { actions: docTypeActions } = slice;

export const useDocTypeSlice = () => {
  useInjectReducer({ key: slice.name, reducer: slice.reducer });
  useInjectSaga({ key: slice.name, saga: docTypeSaga });
